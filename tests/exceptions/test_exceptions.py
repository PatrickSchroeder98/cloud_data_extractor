...
class TestExceptions(unittest.TestCase):
    ...
    def test_CredentialsError_init(self):
        ...
        e = CredentialsError()
        self.assertEqual(
            e.message, self.messages_and_codes["CredentialsError"]["message"]
        )
    ...
    def test_CredentialsError_get_message(self):
        ...
        e = CredentialsError()
        self.assertEqual(
            e.get_message(), self.messages_and_codes["CredentialsError"]["message"]
        )
        del e
    ...
    def test_CredentialsError_get_code(self):
        ...
        e = CredentialsError()
        self.assertEqual(
            e.get_code(), self.messages_and_codes["CredentialsError"]["code"]
        )
        del e
    ...
    def test_CollectionIsNone_init(self):
        ...
        e = CollectionIsNone()
        self.assertEqual(
            e.message, self.messages_and_codes["CollectionIsNone"]["message"]
        )
    ...
    def test_CollectionIsNone_get_message(self):
        ...
        e = CollectionIsNone()
        self.assertEqual(
            e.get_message(), self.messages_and_codes["CollectionIsNone"]["message"]
        )
        del e
    ...
    def test_CollectionIsNone_get_code(self):
        ...
        e = CollectionIsNone()
        self.assertEqual(
            e.get_code(), self.messages_and_codes["CollectionIsNone"]["code"]
        )
        del e
    ...
    def test_ConnectionNotConfigured_init(self):
        ...
        self.assertEqual(
            e.message, self.messages_and_codes["ConnectionNotConfigured"]["message"]
        )
        self.assertEqual(
            e.code, self.messages_and_codes["ConnectionNotConfigured"]["code"]
        )
        del e
    ...
    def test_ConnectionNotConfigured_get_message(self):
        ...
        self.assertEqual(
            e.get_message(),
            self.messages_and_codes["ConnectionNotConfigured"]["message"],
        )
        del e
    ...
    def test_ConnectionNotConfigured_get_code(self):
        ...
        e = ConnectionNotConfigured()
        self.assertEqual(
            e.get_code(), self.messages_and_codes["ConnectionNotConfigured"]["code"]
        )
        del e
